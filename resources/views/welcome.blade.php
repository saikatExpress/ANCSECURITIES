        ...
        <div class="logo-area">
            <div class="row align-items-center">
                <div class="logo col-lg-3 text-center text-lg-left mb-3 mb-md-5 mb-lg-0">
                    ...
                    <img loading="lazy" src="{{ asset('user/assets/logos/logo.png') }}" alt="Constra">
                    </a>
                </div><!-- logo end -->
      ...
      <div class="container">
        <div class="row justify-content-between">
          <div class="col-lg-4 col-md-6 footer-widget footer-about">
            ...
            <img loading="lazy" width="200px" class="footer-logo" src="{{ asset('user/assets/logos/logo.png') }}" alt="Constra">
            <p>
                Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor inci done idunt ut
          ...
          <div class="col-md-6">
            <div class="copyright-info">
              <span>Copyright &copy; <script>
                ...
                </script>, Designed &amp; Developed by <a href="https://github.com/saikatExpress" target="_blank">TS WEB BUILD</a></span>
            </div>
          </div>
