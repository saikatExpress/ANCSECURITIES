                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" placeholder="NID Attachment">
                            </div>
                            <div class="form-group">
                                <label for="">User photo : <span class="text-danger"> * </span></label>
                                <input type="file" class="form-control" placeholder="User photo">
                            </div>
                            <div class="form-group">
                                <label for="">Signature : <span class="text-danger"> * </span></label>
                                <input type="file" class="form-control" placeholder="Signature">
                            </div>
                        </div>
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Cheque leaf">
                            </div>
                            <div class="mt-3"></div>

                            <h6>Nomineee infomation </h6>
                            <hr>
                            <div class="form-group">
                                <label for="">Nomineee name : <span class="text-danger"> * </span></label>
                                <input type="text" class="form-control" placeholder="Nomineee name">
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" placeholder="Nominee NID No">
                            </div>
                            <div class="form-group">
                                <label for="">NID Attachment : <span class="text-danger"> * </span></label>
                                <input type="file" class="form-control" placeholder="NID Attachment">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" placeholder="Nomineee signature">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control" aria-invalid="false" placeholder="NID Attachment">
                            </div>
                            <div class="form-group">
