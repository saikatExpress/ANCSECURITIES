...
<div id="actionDiv" style="position: fixed; top: 7%; border-radius: 4px; width: 84%;z-index:1;">
    <div class="defaultMenubar">
        ...
        <div class="menu-bar1">
            <ul class="menu1">
                <li>
                    <a href="{{ route('desposit.request') }}">
                        Deposit Request <span class="badge badge-danger" style="background-color: darkred;">{{ ($totalDeposit) ?? 0 }}</span>
                    </a>
                </li>
                <li>
