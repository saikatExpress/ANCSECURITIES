<div class="banner-carousel banner-carousel-1 mb-0">
        ...
        <div class="banner-carousel-item" style="background-image:url({{ asset('user/assets/banner/banner2.jpeg') }})">
        ...
        <div class="banner-carousel-item" style="background-image:url({{ asset('user/assets/banner/banner3.jpg') }})">
